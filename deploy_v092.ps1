# Deploy v0.9.2 - 3-layer candidate flow: interpretations -> segmentations -> per-segment
...
Write-Host "=== Deploy v0.9.2 ===" -ForegroundColor Cyan
...
Write-Host "=== Deploy v0.9.2 Complete ===" -ForegroundColor Green
Write-Host "3-layer: interpretations -> segmentation candidates -> per-segment mode"
