# Deploy v0.9.3 - Fix: user-created phrases rank first (freq 9999)
...
Write-Host "=== Deploy v0.9.3 ===" -ForegroundColor Cyan
...
Write-Host "=== Deploy v0.9.3 Complete ===" -ForegroundColor Green
Write-Host "Fix: user-created phrases now rank first (freq 9999)"
