# Deploy v0.8.2 - Page-down split re-segmentation
...
Write-Host "=== Deploy v0.8.2 ===" -ForegroundColor Cyan
...
Write-Host "=== Deploy v0.8.2 Complete ===" -ForegroundColor Green
Write-Host "New: press = at last page to split segment and re-segment"
