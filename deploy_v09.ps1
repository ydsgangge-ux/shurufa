# Deploy v0.9 - Sogou-style: interpretations first, seg mode on page-end
...
Write-Host "=== Deploy v0.9 ===" -ForegroundColor Cyan
...
Write-Host "=== Deploy v0.9 Complete ===" -ForegroundColor Green
Write-Host "New flow: complete sentence candidates first, page-down for more, page-end = segment mode"
