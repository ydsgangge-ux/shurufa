...
class LocalLLMClient:
    ...
    def __init__(self, host: str = None, timeout: float = None):
        ...
        self._last_check_time = 0     # 上次 is_available() 探测时间
        self._last_check_result = False  # 上次探测结果（缓存）
    ...
    def _try_auto_start(self):
        ...
        cmd = [python, script, "--port", "11435", "--gpu", "-1"]
        if model:
    ...
    def is_available(self) -> bool:
        ...
        self._last_check_result = self._available or False
        return self._last_check_result
