# Deploy v0.9.1 - Fix seg mode digit key bug (seg[2] -> seg[3])
...
Write-Host "=== Deploy v0.9.1 ===" -ForegroundColor Cyan
...
Write-Host "=== Deploy v0.9.1 Complete ===" -ForegroundColor Green
Write-Host "Fix: digit keys 1-9 now work in segment mode"
